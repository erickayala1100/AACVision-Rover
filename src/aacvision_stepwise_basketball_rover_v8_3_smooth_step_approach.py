...
def main():
    ...
    try:
        print("=" * 72)
        print("AACVISION STEPWISE BASKETBALL SEARCH + LIDAR MAPPING V8.3 SMOOTH STEP APPROACH")
        print("=" * 72)
        print("Your original travel logic: STOP -> SCAN -> DECIDE -> TURN -> DRIVE.")
        print("Robust orange/YOLO detection with brisk stop-and-recheck approach steps.")
